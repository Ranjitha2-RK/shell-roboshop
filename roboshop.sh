...
do
  ...
  if [ $instance != "frontend" ]; then
      IP=$(aws ec2 describe-instances --instance-ids i-01145e3b9b388d081 --query 'Reservations[0].Instances[0].PrivateIpAddress' --output text)
  else
      IP=$(aws ec2 describe-instances --instance-ids i-01145e3b9b388d081 --query 'Reservations[0].Instances[0].PublicIpAddress' --output text)
  fi
